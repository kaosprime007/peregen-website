...
test('PeregenAI landing page keeps its core positioning and story sections', () => {
  ...
  assert.deepEqual(siteContent.interactions, { soundOn: 'Sound on', soundOff: 'Sound off', cursorLabel: 'PeregenAI orbital cursor', cursorTrail: 'Orbital spark trail', cometAsset: '/shooting-star-galaxy.gif' })
  assert.deepEqual(siteContent.contact, { email: 'support@peregenai.com', address: '5900 Balcones Drive Suite 100, Austin, TX 78731' })
